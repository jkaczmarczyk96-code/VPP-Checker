...
def inject_design():
    st.markdown(
        ...
        :root {
            ...
            --ea-peach: #f59e7a;
            --accent: var(--ea-blue);
            --accent-strong: var(--ea-blue-dark);
            --warning: #b45309;
            --danger: var(--ea-red);
            --shadow: 0 18px 48px rgba(0, 35, 156, 0.10);
            --ea-font: 'DaxlinePro', Arial, Helvetica, sans-serif;
        }

        .stApp {
            background:
                radial-gradient(circle at top right, rgba(60, 219, 192, 0.18), transparent 28rem),
        ...
        [data-testid="stHeader"] {
            ...
            border-bottom: 1px solid rgba(0, 35, 156, 0.10);
        }

        [data-testid="stSidebar"] {
            background:
                linear-gradient(180deg, #ffffff 0%, #f4f8ff 100%);
            border-right: 1px solid rgba(0, 35, 156, 0.12);
            box-shadow: 10px 0 34px rgba(0, 35, 156, 0.05);
        }
        ...
        [data-testid="stSidebar"]::before {
            ...
            display: block;
            height: 6px;
            background: linear-gradient(90deg, var(--ea-blue), var(--ea-mint));
        ...
        .app-hero {
            position: relative;
            overflow: hidden;
            border: 1px solid rgba(0, 35, 156, 0.12);
            border-radius: 8px;
        ...
        .app-hero::before {
            ...
            inset: 0 auto 0 0;
            width: 8px;
            background: linear-gradient(180deg, var(--ea-blue), var(--ea-mint));
        }
        ...
        .app-hero::after {
            ...
            height: 260px;
            border-radius: 50%;
            background: rgba(60, 219, 192, 0.18);
        }
        ...
        .selection-item {
            ...
            box-shadow: 0 10px 28px rgba(0, 35, 156, 0.06);
            padding: 14px 16px;
        }
        ...
        div[data-testid="stChatMessage"] {
            border: 1px solid rgba(0, 35, 156, 0.10);
            border-radius: 8px;
            background: rgba(255, 255, 255, 0.98);
            box-shadow: 0 10px 26px rgba(0, 35, 156, 0.06);
        ...
        div[data-testid="stChatMessage"]:has([data-testid="chatAvatarIcon-user"]) {
            ...
            border-color: rgba(0, 35, 156, 0.16);
        }

        .stChatInputContainer {
            border-top: 1px solid rgba(0, 35, 156, 0.12);
        ...
        [data-baseweb="select"] div:focus {
            outline: 3px solid rgba(60, 219, 192, 0.35) !important;
        ...
        .stButton > button {
            ...
            color: white;
            font-weight: 700;
            box-shadow: 0 10px 22px rgba(0, 35, 156, 0.18);
        }
        ...
        [data-testid="stChatInput"] > div {
            background: rgba(0, 20, 95, 0.96) !important;
        }

        [data-testid="stChatInput"] {
            border-top: 3px solid var(--ea-mint);
            box-shadow: 0 -18px 38px rgba(0, 20, 95, 0.20);
        }
        ...
        [data-testid="stChatInput"] textarea:focus {
            ...
            color: var(--text) !important;
            -webkit-text-fill-color: var(--text) !important;
            border: 1px solid rgba(60, 219, 192, 0.65) !important;
        ...
        [data-testid="stChatInput"] button {
            background: var(--ea-mint) !important;
            color: var(--ea-blue-dark) !important;
            border-radius: 8px !important;
        }

        [data-testid="stChatInput"] button svg {
            color: var(--ea-blue-dark) !important;
            fill: var(--ea-blue-dark) !important;
        }
    ...
    st.markdown(
        ...
        <section class="app-hero">
            <div class="brand-lockup">
                <img class="brand-logo" src="https://www.europ-assistance.cz/assets/img/logo-europ-assistance.svg" alt="Europ Assistance">
                <div class="brand-divider"></div>
                <div class="brand-product">VPP Checker</div>
            </div>
